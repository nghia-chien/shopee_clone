...
import { useUserThreads, useCreateThread } from '../../hooks/useChat';
...
export function ChatPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex max-w-7xl mx-auto w-full my-4">
        {/* Threads List */}
              ...
              <div className="p-4 border-b border-gray-200 bg-gray-50">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center text-white font-semibold">
                    {selectedThread.seller?.name?.charAt(0).toUpperCase() || 'S'}
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900">
                      {selectedThread.seller?.name || t('chat.seller')}
                    </h3>
